# Generated by Django 4.2.6 on 2023-11-05 09:06
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345678', length=10, max_length=20, prefix='Cat', unique=True)),
                ('title', models.CharField(default='food', max_length=100)),
                ('image', models.ImageField(default='cathegory.jpg', upload_to='cathegory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345678', length=10, max_length=20, prefix='pdt', unique=True)),
                ...
                ('description', models.TextField(blank=True, default='This is the description', null=True)),
                ('price', models.DecimalField(decimal_places=2, default='199', max_digits=999999999999999)),
                ...
                ('cathegory', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.cathegory')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('vid', shortuuid.django_fields.ShortUUIDField(alphabet='abcdefgh12345678', length=10, max_length=20, prefix='ven', unique=True)),
                ('title', models.CharField(default='ABCD', max_length=100)),
                ('image', models.ImageField(default='vendor.jpg', upload_to=core.models.user_directory_path)),
                ('description', models.TextField(blank=True, default='This is the best vendor', null=True)),
                ('address', models.CharField(default='123 Main Street.', max_length=100)),
                ('contact', models.CharField(default='+237 987654321', max_length=100)),
                ('chat_resp_time', models.CharField(default='100', max_length=100)),
                ('shipping_on_time', models.CharField(default='100', max_length=100)),
                ('authentication_rating', models.CharField(default='100', max_length=100)),
